    ...
    return (
        <Segment.Group>
            ...
            <Segment clearing attached='bottom'>
                {activity.isHost ? (
                    <>
                        <Button color={activity.isCanceled ? 'green' : 'red'} floated='left' basic content={activity.isCanceled ? 'Reactivate Activity' : 'Cancel Activity'}
                    ...
                    <Button disabled={activity.isCanceled} onClick={updateAttendance} color='teal'>Join Activity</Button>
                )}
            </Segment>
        </Segment.Group>
    )
